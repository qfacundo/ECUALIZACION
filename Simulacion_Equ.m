...
xo=[1.2667e-01   2.3000e-01   4.5000e-01];
r1=xo(1);
b=xo(2);
a=xo(3);
Q1 = 1.65;
...
a2=3*a; b2=b; r2=1.1*r1; Q2=.5*Q1; EMF2=EMF;
a3=a; b3=b; r3=r1; Q3=.8*Q1; EMF3=EMF;
a4=a; b4=b; r4=r1; Q4=.9*Q1;EMF4=EMF;
...
%----- Modelo 1: ___________________    
    ...
    V1(i) = interp1(EMF(:,2),EMF(:,1),Xbm1(2),'spline','extrap') - I1(i)*r1;
...
%----- Modelo 2: ___________________    
    ...
    V2(i) = interp1(EMF2(:,2),EMF2(:,1),Xbm2(2),'spline','extrap') - I2(i)*r2;
...
%----- Modelo 3: ___________________    
    ...
    V3(i) = interp1(EMF3(:,2),EMF3(:,1),Xbm3(2),'spline','extrap') - I3(i)*r3;
...
%----- Modelo 4: ___________________    
    ...
    V4(i) = interp1(EMF4(:,2),EMF4(:,1),Xbm4(2),'spline','extrap') - I4(i)*r4;
